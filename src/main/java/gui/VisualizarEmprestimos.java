 ...
 * @author Airon
 */
public class VisualizarEmprestimos extends javax.swing.JFrame {

    /**
     * Creates new form VisualizarEmprestimos
     */
    ...
    private void initComponents() {
        ...
        setTitle("LibSystem - Empréstimos");

        painelEmprestimos.setBorder(javax.swing.BorderFactory.createTitledBorder("Lista de empréstimos"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarEmprestimos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
